...
const PLANS = [
  {
    ...
    price: "₹499",
    cadence: "/month",
    desc: "Get the engine running. Targeted applications, every single day.",
    features: [
  ...
  },
  {
    ...
    price: "₹999",
    cadence: "/month",
    desc: "Highest leverage. Priority pilots and Career Shield protection.",
    features: [
...
export default function Pricing() {
  return (
    <section id="pricing" className="relative py-28 md:py-36" data-testid="pricing-section">
      <div className="absolute inset-0 jp-dot-grid opacity-20 pointer-events-none" />
      <div className="relative max-w-7xl mx-auto px-6 md:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <span className="text-xs uppercase tracking-[0.24em] text-zinc-400 font-semibold">Pricing</span>
          <h2 className="font-display mt-3 text-4xl md:text-5xl lg:text-6xl tracking-[-0.03em] leading-[1.02] text-zinc-900 font-medium">
            Targeted applications.<br /><span className="text-zinc-400">Never spam.</span>
          </h2>
          <p className="mt-5 text-zinc-500 text-lg">
            Every application is matched to your experience, skills, preferred locations, salary expectations and work authorization. Quality over volume — always.
          </p>
        </div>
        ...
        <p className="mt-10 text-center text-sm text-zinc-400 max-w-2xl mx-auto">
          Want to try first? <Link to="/signup" className="text-zinc-700 underline underline-offset-2 jp-link">Start free</Link> — 10 matched jobs/month, AI resume update, LinkedIn optimizer. No auto-apply.
        </p>
      </div>
    </section>
  );
