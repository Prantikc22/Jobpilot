...
export default function RefundPolicy() {
  return (
    <LegalShell title="Refund & Cancellation Policy" updated="July 2025" testid="page-refund">
      <P>
        ApplyAgent is a digital SaaS product billed via Razorpay. We want you to be entirely satisfied. This policy explains when and how you can request a refund or cancel your subscription.
      </P>

      <H2>1. Subscription cancellation</H2>
      <P>
        You can cancel your Starter or Pro subscription at any time from your dashboard or by emailing <a href="mailto:support@getapplyagent.com" className="underline">support@getapplyagent.com</a>. Cancellation takes effect at the end of the current billing cycle and you continue to have access to paid features until then. You will not be charged again.
      </P>

      <H2>2. Refunds — 7-day money-back guarantee</H2>
      <P>
        If you are unhappy with ApplyAgent for any reason, contact us within <strong>7 days</strong> of your initial purchase and we will refund 100% of that payment, no questions asked.
      </P>
      <UL>
        <li>Eligibility: applies to the very first paid invoice on your account.</li>
        <li>Process: email support@getapplyagent.com from the address used at sign-up; refunds are issued to the original payment method within 5–10 business days.</li>
      ...
      <P>
        Email <a href="mailto:support@getapplyagent.com" className="underline">support@getapplyagent.com</a> with subject “Refund request” and include your account email and Razorpay payment ID. We respond within one business day.
      </P>
    </LegalShell>
  );
}
